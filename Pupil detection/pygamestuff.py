...
def findRect(x, y) :
        if pygame.mouse.get_pos()[0] > x and pygame.mouse.get_pos()[0] < (x+750) and pygame.mouse.get_pos()[1] > y and pygame.mouse.get_pos()[1] < (y+720):
                return True
        else:
                return False
...
##        print self.crossrect.left, "is the left"
    ...
    def draw(self):
        ...
        #w,h
        screen.fill(white)
        pygame.draw.rect(screen,white,pygame.Rect(pos1[0],pos1[1],750,720))
        pygame.draw.rect(screen,white,pygame.Rect(pos2[0],pos2[1],750,720))
        if findRect(0,0):
                 pygame.draw.rect(screen,black,pygame.Rect(pos1[0],pos1[1],750,720))
        if findRect(750,0):
                 pygame.draw.rect(screen,black,pygame.Rect(pos2[0],pos2[1],750,720))
